---
title: "BBNet – Simple predictive models based on Bayesian belief networks"
author: "Victoria Dominguez Almela & Richard Stafford"
...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/bbnetwebasm)](https://CRAN.R-project.org/package=bbnetwebasm)
[![Codecov test coverage](https://codecov.io/gh/spakcjl/bbnetwebasm/branch/main/graph/badge.svg)](https://app.codecov.io/gh/spakcjl/bbnetwebasm?branch=main)
...
[our GitHub repository](https://github.com/spakcjl/bbnetwebasm/issues).

# Citation

If you found the package and/or the tutorial useful, please do not hesitate to
cite the package as an acknowledgement for the time spent in writing the package 
and this tutorial. 
